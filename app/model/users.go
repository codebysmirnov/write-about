...
func (userL) LoadDiaries(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadPeople(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
...
func (o *User) AddDiaries(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Diary) error {
	var err error
...
func (o *User) SetDiaries(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Diary) error {
	...
	return o.AddDiaries(ctx, exec, insert, related...)
}
...
// Sets related.R.User.
func (o *User) RemoveDiaries(ctx context.Context, exec boil.ContextExecutor, related ...*Diary) error {
	var err error
	for _, rel := range related {
		queries.SetScanner(&rel.UserID, nil)
		if rel.R != nil {
...
// Sets related.R.User appropriately.
func (o *User) AddPeople(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Person) error {
	var err error
	for _, rel := range related {
		if insert {
			queries.Assign(&rel.UserID, o.ID)
...
func (o *User) SetPeople(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Person) error {
	...
	return o.AddPeople(ctx, exec, insert, related...)
}
...
// Sets related.R.User.
func (o *User) RemovePeople(ctx context.Context, exec boil.ContextExecutor, related ...*Person) error {
	var err error
	for _, rel := range related {
		queries.SetScanner(&rel.UserID, nil)
		if rel.R != nil {
